...
class OrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('manager.pages.order.create', compact('shippings', 'cart'));
    }
    ...
    public function show($id)
    {
        ...
        if (!is_null($orderDetails)) {
            return view('manager.pages.order.details', compact('orderDetails','shippings'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (!is_null($order))
        {
            ...
            return view('manager.pages.order.update', compact('order','carts','net_price','total_price'));
        }
    }
    ...
    public function print($id)
    {
        ...
        $carts = Cart::where('order_id', $id)->get();
        $settings = Settings::first();
        return view('manager.pages.order.invoice', compact('orders','carts', 'settings'));
    }
