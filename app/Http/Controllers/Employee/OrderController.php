...
class OrderController extends Controller
{
    ...
    public function index()
    {
       ...
       return view('employee.pages.order.manage', compact('settings' , 'orders','last'));
    }
    ...
    public function processing()
    {
       ...
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',1)->paginate(15);
       return view('manager.pages.order.manage', compact('settings' , 'orders','last'));
    }

    public function hold()
    {
       $settings = Settings::first();
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',2)->paginate(15);
       return view('manager.pages.order.manage', compact('settings' , 'orders','last'));
    }
    ...
    {
       $settings = Settings::first();
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',3)->paginate(15);
       return view('manager.pages.order.manage', compact('settings', 'orders','last'));
    }
    ...
    {
       $settings = Settings::first();
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',4)->paginate(15);
       return view('manager.pages.order.manage', compact('settings', 'orders','last'));
    }
    ...
    {
       $settings = Settings::first();
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',5)->paginate(15);
       return view('manager.pages.order.manage', compact('settings', 'orders','last'));
    }
    ...
    {
       $settings = Settings::first();
       $orders = Order::orderBy('id','desc')->where('order_assign', Auth::user()->id)->where('status',6)->paginate(15);
       return view('manager.pages.order.manage', compact('settings', 'orders','last'));
    }
    ...
    public function create()
    {
        ...
        return view('employee.pages.order.create', compact('shippings', 'cart'));
    }
    ...
    public function show($id)
    {
        ...
        if (!is_null($orderDetails)) {
            return view('employee.pages.order.details', compact('orderDetails','shippings'));
        }
    }
    ...
    public function edit($id)
    {
        ...
        if (!is_null($order))
        {
            ...
            return view('employee.pages.order.update', compact('order','carts','net_price','total_price'));
        }
    }
    ...
    public function print($id)
    {
        ...
        $carts = Cart::where('order_id', $id)->get();
        $settings = Settings::first();
        return view('employee.pages.order.invoice', compact('orders','carts', 'settings'));
    }
    ...
    public function printCheckedOrders(Request $request)
    {
        ...
        return view('manager.pages.order.bulk_invoices', compact('orders','settings'));
