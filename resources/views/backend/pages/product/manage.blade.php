 ...
 <div class="br-pagetitle">
            ...
            <div class="br-pagebody">
                        <div class="br-section-wrapper">
                          ...
                          <a href="{{route('product.create')}}" class="btn btn-success btn-sm my-3">Add Product</a>
                             ...
                             <table class="table mg-b-0 table-bordered table-striped">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <p><span class="badge badge-warning">Assigned</span><a href="{{route('assign_dlt',$product->id)}}" onclick="return confirm('do you confirm to delete')" ><i class="fa fa-trash" style
                                            ="color: red;"></i></a></p>
                                            @endif
                                        </td>
