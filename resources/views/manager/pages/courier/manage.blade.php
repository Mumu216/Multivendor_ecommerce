 ...
 <div class="br-pagetitle">
            ...
            <div class="br-pagebody" >
                        <div class="br-section-wrapper">
                          ...
                          <a href="{{ route('manager.courier.create')}}" class="btn btn-success btn-sm my-2">Add courier</a>
                                ...
                                <table class="table mg-b-0 table-bordered table-striped" >
                                    ...
                                    <tbody>
                                      ...
                                      <td class="action-button">
                                          ...
                                          <ul>
                                              <li><a href="{{route('manager.courier.edit', $courier->id)}}"><i class="fa fa-edit"></i></a></li>
